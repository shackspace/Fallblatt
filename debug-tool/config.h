...
// For AP mode:
const char *ssid = "shack";  // You will connect your phone to this Access Point
const char *pw = "welcome2shack"; // and this is the password
...
#define SERIAL_PARAM1 SERIAL_8E2    // Data/Parity/Stop UART1
